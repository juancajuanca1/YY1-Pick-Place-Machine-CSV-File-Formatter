...
double get _tableWidth =>
    _wDot + _wRef + _wVal + _wFp + _wSide + _wX + _wY +
    _wSlot + _wSpeed + _wPick + _wPlace + _wAct;
...
class PlacementAssignmentScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    for (final g in groups) {
      final visible =
          g.records.where((r) => r.side == project.exportSide).toList();
    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        Expanded(
          child: _HScrollTable(items: items),
        ),
          ...
          child: ListView.builder(
            ...
            itemBuilder: (_, i) {
              ...
              return _ComponentRow(
                  record: ri.record, isDuplicate: ri.isDuplicate);
            },
          ),
        ),
      ]);
...
class _GroupItem  extends _Item { final AssignmentGroup group; _GroupItem(this.group); }
...
class _GlobalParamBarState extends ConsumerState<_GlobalParamBar> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Wrap(spacing: 24, runSpacing: 8, alignment: WrapAlignment.center, children: [
        _ParamField(
          label: 'Speed (%)',
          ...
          onApply: () {
            ...
            if (v != null) ref.read(projectProvider.notifier).applyGlobalSpeed(v);
          },
        ),
        _ParamField(
          ...
          onApply: () {
            ...
            if (v != null) ref.read(projectProvider.notifier).applyGlobalPickHeight(v);
          },
        ),
        _ParamField(
          ...
          onApply: () {
            ...
            if (v != null) ref.read(projectProvider.notifier).applyGlobalPlaceHeight(v);
          },
        ),
      ]),
    );
...
class _StatsBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final onSide   = project.records.where((r) => r.side == project.exportSide).length;
    final assigned = project.records
        .where((r) => r.side == project.exportSide && (r.feederSlot != null || r.isFiducial))
        .length;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        const SizedBox(width: 8),
        Expanded(
          child: Text('Duplicate feeder slots: ${dupeSlots.join(', ')}',
              style: Theme.of(context)
                  .textTheme
                  .bodySmall
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        SizedBox(width: _wRef,   child: Text('Ref.',       style: s)),
        SizedBox(width: _wVal,   child: Text('Value',      style: s)),
        SizedBox(width: _wFp,    child: Text('Footprint',  style: s)),
        SizedBox(width: _wSide,  child: Text('Side',       style: s)),
        SizedBox(width: _wX,     child: Text('Mid X (mm)', style: s, textAlign: TextAlign.center)),
        SizedBox(width: _wY,     child: Text('Mid Y (mm)', style: s, textAlign: TextAlign.center)),
        SizedBox(width: _wSlot,  child: Text('Feeder #',   style: s, textAlign: TextAlign.center)),
        SizedBox(width: _wSpeed, child: Text('Speed %',    style: s, textAlign: TextAlign.center)),
        SizedBox(width: _wPick,  child: Text('Pick H.',    style: s, textAlign: TextAlign.center)),
        SizedBox(width: _wPlace, child: Text('Place H.',   style: s, textAlign: TextAlign.center)),
...
class _ComponentRow extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        // Designator chip
        SizedBox(width: _wRef, child: _chip(context, record.designator, dimmed, isFiducial, colors)),
        // Value
        SizedBox(
          width: _wVal,
        ...
        SizedBox(
          width: _wX,
          child: Text(record.xMm.toStringAsFixed(3),
              textAlign: TextAlign.center,
              style: Theme.of(context).textTheme.bodySmall?.copyWith(
        ...
        SizedBox(
          width: _wY,
          child: Text(record.yMm.toStringAsFixed(3),
              textAlign: TextAlign.center,
              style: Theme.of(context).textTheme.bodySmall?.copyWith(
                  fontFamily: 'monospace',
                  color: colors.onSurfaceVariant)),
        ...
        SizedBox(
          ...
          child: _EditableCell(
            ...
            onSave: (v) {
              ...
              if (iv != null) {
                ref.read(projectProvider.notifier).setMountSpeed(record.id, iv);
              }
            },
          ),
        ),
        ...
        SizedBox(
          ...
          child: _EditableCell(
            ...
            onSave: (v) {
              ...
              if (dv != null) {
                ref.read(projectProvider.notifier).setPickHeight(record.id, dv);
              }
            },
          ),
        ),
        ...
        SizedBox(
          ...
          child: _EditableCell(
            ...
            onSave: (v) {
              final dv = double.tryParse(v);
              if (dv != null) {
                ref.read(projectProvider.notifier).setPlaceHeight(record.id, dv);
              }
            },
          ),
        ),
        ...
        SizedBox(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            IconButton(
              ...
              tooltip: record.enabled ? 'Exclude from export' : 'Include in export',
              onPressed: () =>
                  ref.read(projectProvider.notifier).toggleEnabled(record.id),
            ),
            IconButton(
              visualDensity: VisualDensity.compact,
              padding: EdgeInsets.zero,
  ...
  Widget _chip(BuildContext ctx, String text, bool dimmed, bool fiducial,
      ColorScheme colors) {
    Color bg  = dimmed ? colors.surfaceContainerHighest : colors.primaryContainer;
    Color fg  = dimmed ? colors.onSurfaceVariant : colors.onPrimaryContainer;
    if (fiducial && !dimmed) {
  ...
  Future<void> _confirmDelete(
      BuildContext context, WidgetRef ref, PlacementRecord rec) async {
        ...
        decoration: InputDecoration(
          ...
          border: OutlineInputBorder(
              ...
              borderSide: BorderSide(
                  color:
                      widget.isDuplicate ? colors.error : colors.outline)),
    ...
    return GestureDetector(
      ...
      child: Tooltip(
        ...
        child: Container(
          ...
          child: Center(
            child: Text('${widget.value} ${widget.suffix}',
      ...
      child: Row(children: [
        ...
        ElevatedButton.icon(
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor:
                canExport ? Colors.green : colors.surfaceContainerHighest,
            foregroundColor:
                canExport ? Colors.white : colors.onSurfaceVariant,
